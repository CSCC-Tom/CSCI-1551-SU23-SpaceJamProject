...
class SpaceJamPlayerShip(BaseClasses.ObjectWithModel):
    ...
    def __init__(
        ...
        self.shipObj = self.loadAndAddModelNodePath(
            loader,
            scene_node,
    ...
    def getShipForward(self):
        ...
        return self.scene_node.getRelativeVector(self.shipObj, Vec3(0, 1, 0))
    ...
    def getShipRight(self):
        ...
        return self.scene_node.getRelativeVector(self.shipObj, Vec3(1, 0, 0))

    def getShipUp(self):
        """Convenience to get the vector representing the current upward direction from the ship's perspective."""
        return self.scene_node.getRelativeVector(self.shipObj, Vec3(0, 0, 1))
